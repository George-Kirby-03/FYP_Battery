function [ tv,xv ] = simulateDynamics( problem, simtime, u_crt, x_crt, tstep, odesolver )
...
if strcmp(odesolver,'ode113')
    [tv,xv]=ode113(@(t,x)odewrapSimDynamics(t,x,u_crt,problem),T,x_crt);
elseif strcmp(odesolver,'ode45') 
    [tv,xv]=ode45(@(t,x)odewrapSimDynamics(t,x,u_crt,problem),T,x_crt);
elseif strcmp(odesolver,'ode23') 
    [tv,xv]=ode23(@(t,x)odewrapSimDynamics(t,x,u_crt,problem),T,x_crt);
else
