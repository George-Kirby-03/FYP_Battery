...
figure
hold on
plot(tt,-y.*u1,'b-' ,'LineWidth',2)
plot([solution.T(1,1); solution.tf],[problem.constraints.gl(2), problem.constraints.gl(2)],'r-' )
plot([solution.T(1,1); solution.tf],[problem.constraints.gu(2), problem.constraints.gu(2)],'r-' )
ylim([problem.constraints.gl(2)-10 problem.constraints.gl(2)+10])
xlabel('Time [s]')
ylabel('Output: output power [W]')
grid on
