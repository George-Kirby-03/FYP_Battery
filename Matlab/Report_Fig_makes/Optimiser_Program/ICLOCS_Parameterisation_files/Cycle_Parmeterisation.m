function sim_handler = Cycle_Parmeterisation(cycle,dynamics,upper_dynamics,lower_dynamics,settings,enforce,ocv_curve)
%CYCLE_PARMETERISATION undefined
%   undefined
arguments (Input)
    cycle
    dynamics struct = struct()
    upper_dynamics struct = struct()
    lower_dynamics struct = struct()
...
[problem,guess]=BatteryEstimation_temp(cycle,settings,dynamics,upper_dynamics,lower_dynamics,enforce,ocv_curve);   
