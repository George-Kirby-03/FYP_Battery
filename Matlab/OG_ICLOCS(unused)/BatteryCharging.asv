...
problem.states.xfl=[0 x2f_min];
problem.states.xfu=[1 x2f_max];
...
problem.constraints.gl=[3.5 100];
problem.constraints.gu=[4.7 inf];
problem.constraints.gTol_neq=[0.001 0.001];
...
%
%------------- BEGIN CODE --------------
% x1=xf(1); x2=xf(2); u1=uf(1)
% voltage = 3.64 + x1*0.55 - 0.72*(x1.^2) + 0.75*(x1.^3) + x2 + (vdat.R0).*u1;
