...
problem.mp.time.t_min(2:5)=[100,835,1285,1805];
problem.mp.time.t_max(2:5)=[100,835,1285,1805];
guess.mp.time(2:5)=[100,835,1285,1805];
...
problem.mp.parameters.pl(1:4)=[2.6, 2.6, 2.4, 2.08];
problem.mp.parameters.pu(1:4)=[2.6, 2.6, 2.4, 2.08];
guess.mp.parameters(1:4)=[2.6, 2.6, 2.4, 2.08];
...
problem.mp.data.batt_Cp=2652.737;
problem.mp.data.batt_h=45.67;
...
start_soc = 0.06;
x0ul{1}=[start_soc 0 problem.mp.data.TempAmb;start_soc 0 problem.mp.data.TempAmb];
