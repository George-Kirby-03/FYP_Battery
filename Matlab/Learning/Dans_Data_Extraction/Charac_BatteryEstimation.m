...
[problem,guess]=Charac_BatteryEstimation_temp('..\..\..\cycle_exports\MOLI_28\MOLI_cycle_1501.mat');          % Fetch the problem definition
options= problem.settings(1500);                  % Get options and solver settings 
