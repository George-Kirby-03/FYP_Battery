...
problem.mp.time.t_min=[0 1 2 3 4];     
problem.mp.time.t_max=[0 60*60 60*60 60*60 60*60]; 
guess.mp.time=[0 5*60 8*60 10*60 10*60];
...
x0ul{2}=[0.2 0 0;0.2 0.25 Temp_Max];
x0ul{3}=[0.4 0 0;0.4 0.25 Temp_Max];
x0ul{4}=[0.6 0 0;0.6 0.25 Temp_Max];
