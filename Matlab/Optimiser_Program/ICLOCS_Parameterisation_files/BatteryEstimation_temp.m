...
y = cycle_file.volts;
u1 = cycle_file.amps;
tp = cycle_file.temp - min(cycle_file.temp);
...
if ~(enforce.capacitance == 0 && enforce.R0 == 0 && enforce.R1 == 0 ) && (enforce.capacitance == 0 || enforce.R0 == 0 || enforce.R1 == 0)
...
coef = sum(p(:,1:vdat.poly.polycount));
