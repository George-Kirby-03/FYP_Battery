...
avg_sim_handle_b1 = sim_average(sim_handler,5,'Start');
avg_sim_handle_b1.current_sol.Q = avg_sim_handle_b1.current_sol.Q  - 700;
...
charge_protocol.charge_currents = [2 1.8 1.65 0.9 0.75] * 1.5; %Specify current per segment in c
