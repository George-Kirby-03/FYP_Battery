...
plot([cycle_count{3},cycle_count{3}(1) + cycle_count{9}],[Sum_r{3},Sum_r{9}],'LineStyle','-.','LineWidth',2,'Color','r')
plot([cycle_count{4},cycle_count{4}(1) + cycle_count{10}],[Sum_r{3},Sum_r{10}],'LineStyle','-','LineWidth',2,'Color','r')

plot(cycle_count{5},Sum_r{5},'LineStyle','-.','LineWidth',2,'Color','g')
plot([cycle_count{4},cycle_count{4}(1)+ cycle_count{9}],[Sum_r{3},Sum_r{10}],'LineStyle','-','LineWidth',2,'Color','g')
