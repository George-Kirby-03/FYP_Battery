...
charge_protocol.charge_segments = [0,20]; %Specify as many segments
charge_protocol.charge_currents = [2]; %Specify current per segment
...
charge_protocol.charge_CV = 'True'; %'False' not currently implamented
