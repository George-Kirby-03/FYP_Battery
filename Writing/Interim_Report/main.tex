...
Its would be good to see how the ecm parts change over degredation to see future behaviour
\subsubsection{Objectives}
\begin{itemize}
    \item Attempt optimal controll methods to parametrise lithium batteries
    \item Apply different controll objectives to battery charging to see degredation effects
    \item See how affective adaptive methods are in the charging process as the battery ages
    \item Feed results to nerual network ...
\end{itemize}
...
This https://www.sciencedirect.com/science/article/pii/S2352152X2400584X nicley shows the overpotential of the battery relating to the differend of the output of the battery to the equlibrium potnetial of the battery. Shown as the summation of eletrolyte opverpotential, Li concentration overportnetial, kenetic overpotential 

and resistive overpotential. This are equated witin the ecm model as the polorixing rc, and r. 
https://www.sciencedirect.com/science/article/pii/S0378775313020880#bib5 gives the 

Just say, that theres models for overpotnetial which can cause the dendrite formations, these are caused by to fast ofcharge and overcharging. 
