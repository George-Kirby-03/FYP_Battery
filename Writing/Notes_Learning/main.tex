...
\section{Iclocs Optyimisation}

Found an example (Excample Windshear), which also tries to minimise a upper/lower bound on a state (yay!), using this approach in order to minimise the maxiumum temperature during the charge. 
